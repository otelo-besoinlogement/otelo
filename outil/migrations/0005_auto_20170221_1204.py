...
# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-21 11:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('outil', '0004_parametreze_b11_autre'),
    ]

    operations = [
        migrations.AddField(
            model_name='parametreze',
            name='autre_source_b12',
            field=models.IntegerField(default=0),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b12_cohab_interg_subie',
            field=models.BooleanField(default=True),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b12_heberg_autre',
            field=models.BooleanField(default=False),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b12_heberg_gratuit',
            field=models.BooleanField(default=True),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b12_heberg_particulier',
            field=models.BooleanField(default=True),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b12_heberg_temporaire',
            field=models.BooleanField(default=True),
        ),
    ]
