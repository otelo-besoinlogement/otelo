...
# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-05-02 08:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('outil', '0014_auto_20170410_1138'),
    ]

    operations = [
        migrations.AddField(
            model_name='parametreze',
            name='b12_ventilation',
            field=models.IntegerField(default=100),
        ),
        migrations.AlterField(
            model_name='parametreze',
            name='b2_scenario_omphale',
            field=models.CharField(default='MIG_BASSES', max_length=50),
        ),
    ]
