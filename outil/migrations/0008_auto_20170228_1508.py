...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('outil', '0007_auto_20170223_1553'),
    ]

    operations = [
        migrations.AddField(
            model_name='parametreze',
            name='b2_scenario_omphale',
            field=models.CharField(default='CENTRAL', max_length=50),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b2_tx_disparition',
            field=models.FloatField(default=9999),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b2_tx_residence_secondaire',
            field=models.FloatField(default=9999),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b2_tx_restructuration',
            field=models.FloatField(default=9999),
        ),
        migrations.AddField(
            model_name='parametreze',
