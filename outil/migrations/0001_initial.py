    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_ze', models.CharField(max_length=6)),
                ('source_b11', models.CharField(choices=[('RP', 'Recensement INSEE'), ('SNE', "Système National d'Enregistrement"), ('Autre', 'Autre source de données')], max_length=4)),
                ('autre_source_b11', models.IntegerField()),
            ],
        ),
    ]
