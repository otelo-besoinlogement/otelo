...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('outil', '0005_auto_20170221_1204'),
    ]

    operations = [
        migrations.AddField(
            model_name='parametreze',
            name='b13_taux_effort',
            field=models.IntegerField(default=30),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b14_locataire_hlm',
            field=models.BooleanField(default=False),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b14_locataire_hors_hlm',
            field=models.BooleanField(default=True),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b14_proprietaire',
            field=models.BooleanField(default=False),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b14_rp_abs_sani',
            field=models.BooleanField(default=True),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b14_rp_abs_sani_chauf',
            field=models.BooleanField(default=False),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b14_rp_abs_sani_ou_chauf',
            field=models.BooleanField(default=False),
        ),
    ]
