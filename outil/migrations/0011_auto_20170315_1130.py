...
# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-15 10:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('outil', '0010_auto_20170313_1640'),
    ]

    operations = [
        migrations.AddField(
            model_name='parametreze',
            name='b13_ventilation',
            field=models.IntegerField(default=100),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b14_ventilation',
            field=models.IntegerField(default=100),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b15_ventilation',
            field=models.IntegerField(default=100),
        ),
        migrations.AddField(
            model_name='parametreze',
            name='b1_taux_mobilite',
